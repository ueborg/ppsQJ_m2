#!/usr/bin/env python3
"""Per-arm analysis and quality control for TASK-2026-09-03-MOCK-LOWLAMBDA-EXTENSION.
...
Those are cross-arm quantities -- every curve here mixes this task's four new
low-lambda populations with the thirteen reused from
../frozen_inputs/predecessor_nc1024_populations.csv -- and they belong to
../analysis/lowlambda_analysis.py, which is the single place the frozen
...
print(f"\nwrote {dest}")
print("Cross-arm quantities (the 17-point curves, the join test, the crossing")
print("protocol and X1-X7) are evaluated ONLY by")
print("../analysis/lowlambda_analysis.py.")
