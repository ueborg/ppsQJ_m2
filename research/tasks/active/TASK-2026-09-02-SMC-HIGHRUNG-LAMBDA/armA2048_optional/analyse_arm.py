#!/usr/bin/env python3
"""Per-arm analysis and quality control for TASK-2026-09-02-SMC-HIGHRUNG-LAMBDA.
...
Those are cross-arm quantities (ARM C's central point lives in armA512) and they
belong to ../analysis/combined_analysis.py, which is the single place the frozen
falsification targets are evaluated.
...
print(f"\nwrote {dest}")
print("Cross-arm quantities (rung deltas, lambda stencils, the frozen F1-F7)")
print("are evaluated ONLY by ../analysis/combined_analysis.py.")
